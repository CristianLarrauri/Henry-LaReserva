						...
						{(userInfo.ban === true && (
							...
							(userInfo.ban === 'dc' && (
								<Route
									...
									path="/pago"
									render={(props) => (
										<Login {...props} authed={false} to={'/pago'} />
									)}
								/>
							))}
						...
						{(userInfo.ban === true && (
							...
							(userInfo.ban === 'dc' && (
								<Route
									...
									path="/inscription"
									render={(props) => (
										<Login {...props} authed={false} to={'/inscription'} />
									)}
								/>
							))}
						...
						{(userInfo.ban === true && (
							...
							(userInfo.ban === 'dc' && (
								<Route
									...
									path="/panel"
									render={(props) => (
										<Login {...props} authed={false} to={'/panel'} />
									)}
								/>
							))}
						...
						{(userInfo.admin === true && (
							...
							(userInfo.admin === 'dc' && (
								<Route
									...
									path="/admin"
									render={(props) => (
										<Login {...props} authed={false} to={'/admin'} />
									)}
								/>
						...
						{(userInfo.admin === true && (
							...
							(userInfo.admin === 'dc' && (
								<Route
									...
									path="/admin/modify/:id"
									render={(props) => (
										<Login {...props} authed={false} to={'/admin/modify/:id'} />
									)}
								/>
						...
						{(userInfo.admin === true && (
							...
							(userInfo.admin === 'dc' && (
								<Route
									...
									path="/create"
									render={(props) => (
										<Login {...props} authed={false} to={'/create'} />
									)}
								/>
