				...
				<div>
					<Switch>
						...
						{(userInfo.ban===true && <Route exact path="/inscription" component={Ban}/>) ||
						 ...
						 (userInfo.ban===undefined) && <Route exact path="/inscription" component={Loading}/> ||
						 (userInfo.ban==='dc') && <Route exact path="/inscription" component={Home}/>}
						
						
						{/*ADMIN*/}
						{(userInfo.admin === true && <Route exact path="/admin" component={DashBoardAdmin} />) ||
						(userInfo.admin === undefined && <Route exact path="/admin" component={Loading} />) ||
						<Route exact path="/admin" component={Home} />}
						
						{(userInfo.admin === true && <Route exactpath="/admin/modify/:id" component={ModifyTournaments}/>) ||
						(userInfo.admin === undefined && <Route exactpath="/admin/modify/:id" component={Loading}/>) ||
						<Route exact path="/admin/modify/:id" component={Home}/>}
						
						{(userInfo.admin === true && <Route exact path="/create" component={CreateTournament}/>) ||
						(userInfo.admin === undefined && <Route exact path="/create" component={Loading}/>) ||
