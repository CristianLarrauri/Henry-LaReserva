...
export default function About() {
  const teamInfo = [
    ...
    {fullName: 'MAURO ALOS', github: 'https://github.com/MauroDavid512', linkedin: 'https://www.linkedin.com/in/mauro-alós-89432b193', picture: mauro, stats: [75,84,69,87,85,62]}
  ];
