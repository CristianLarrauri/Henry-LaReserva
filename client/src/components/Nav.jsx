    ...
    <div className="flex flex-col justify-between items-center w-full bg-white xl:flex-row border-b-8">
      ...
      <div className="w-9/12 flex justify-center ml-6 flex-wrap items-center xl:justify-between xl:flex-nowrap">
        ...
        <div className="flex justify-between mt-3">
          <Link to='/'className="text-stone-400 text-2xl mr-10 hover:text-green-500">Torneos</Link>
          <Link to='/inscription'className="text-stone-400 text-2xl hover:text-green-500">Inscripciones</Link>
        </div>
        
        <SearchBar/>

        <div className="flex items-center mt-3 mb-3 mr-6">
          <Link to='/' className="min-w-[60px] h-[60px] rounded-full overflow-hidden mr-2 bg-green-600">
